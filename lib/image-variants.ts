 ...
 * srcset перечисляет ровно их же. После полного backfill (2026-05-29) R2
 * variants стали обязательным инвариантом: отсутствие `-400`/`-800` даёт 404
 * на выбранный браузером кандидат. Проверка/дозаливка — scripts/backfill-cover-variants.ts.
 */

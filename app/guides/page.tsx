...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: 'Гайды по ИИ для бизнеса',
    description:
      'Практические материалы о внедрении ИИ, автоматизации и проектах для бизнеса.',
    type: 'website',
    url: '/guides',
  },
}
  ...
  return (
    <div className="mx-auto max-w-6xl px-4 py-8 md:py-10 lg:py-12">
      <header className="mb-10 max-w-3xl">
        <p className="mb-3 text-[12px] font-semibold uppercase text-accent">Практика</p>
        ...
        <p className="mt-4 text-[18px] leading-relaxed text-hero-muted">
          Опорные материалы, которые помогают перейти от новостей и пилотов к рабочим ИИ-процессам:

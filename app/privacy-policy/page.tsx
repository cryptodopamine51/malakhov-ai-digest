  ...
  return (
    <article className="mx-auto max-w-3xl px-4 py-10 article-body">
      ...
      <ul>
        ...
        <li>направлять запросы по обработке, уточнению или удалению данных через контакты оператора;</li>
        <li>управлять cookies и аналитикой через настройки браузера — см. также страницу{' '}

 ...
 *
 * Обязательный шаг ПЕРЕД включением NEXT_PUBLIC_R2_IMAGE_VARIANTS=on: пока у
 * обложки нет вариантов, нативный `<img srcset>` будет 404-ить на выбранный
 * браузером кандидат (-400/-800). После полного зелёного прогона инвариант
 * «у каждой R2-обложки есть варианты» закрыт; forward-аплоады (image-generator
 * + cover-скрипты) генерят варианты сами через uploadWebpWithVariants.
 *

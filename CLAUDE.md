...
Последняя инициатива (closed 2026-05-23, morning): **Wave 4 scene matcher + recent rescore + broader cover backfill + sanitizer stock-placeholder filter**. Закрытие хвостов после `spec_2026-05-22_digest_editorial_priority.md`:

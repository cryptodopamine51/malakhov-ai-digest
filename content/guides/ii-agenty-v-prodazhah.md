...
1. **ИИ-помощник менеджера.** Готовит черновик письма, кратко пересказывает звонок, предлагает следующий шаг. Человек всё проверяет и отправляет сам.
2. **ИИ-автоматизация продаж.** Выполняет повторяемое действие по правилу: создаёт задачу, заполняет поле, напоминает о сделке, собирает карточку лида.
3. **ИИ-агент для продаж.** Получает цель, сам выбирает несколько шагов, обращается к CRM и базе знаний, а на спорных местах передаёт решение менеджеру.
...
## Кейс: ИИ-агент квалификации и follow-up в B2B-продажах

...
> Главная мысль: ИИ-агент окупается на типовых обращениях с ответом в базе знаний — статус заказа, условия возврата, настройка продукта. Деньги, конфликты и нестандартные случаи остаются за человеком, а качество держится не на модели, а на базе знаний и правилах эскалации.
...
Самая частая причина провала агента поддержки — не слабая модель, а пустая или противоречивая база знаний. Агент отвечает по тем материалам, которые ему дали: если в базе два разных регламента возврата, он будет уверенно цитировать оба.
...
- **Границы ответа.** Агент отвечает только по базе знаний; на вопрос вне её он не сочиняет, а говорит, что уточнит, и зовёт оператора.

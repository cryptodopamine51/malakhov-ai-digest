...
Если нужно быстро посчитать бюджет, используйте отдельный разбор [сколько стоит внедрение ИИ в компанию](/guides/skolko-stoit-vnedrenie-ii-v-kompaniyu). Если вопрос в выборе стартового процесса, начните с гайда [как выбрать первый ИИ-проект в бизнесе](/guides/kak-vybrat-pervyj-ii-proekt-v-biznese) и вернитесь к этой дорожной карте для запуска.
...
5. [Как выбрать первый проект с ИИ](#как-выбрать-первый-проект-с-ии)
...
5. **Gartner, 2024.** Gartner прогнозировал, что минимум 30% проектов генеративного ИИ будут остановлены после проверки концепции к концу 2025 года из-за качества данных, контроля рисков, расходов или размытой бизнес-ценности — https://www.gartner.com/en/newsroom/press-releases/2024-07-29-gartner-predicts-30-percent-of-generative-ai-projects-will-be-abandoned-after-proof-of-concept-by-end-of-2025
...
8. **«Яков и Партнёры»: исследование «Искусственный интеллект в России — 2025: тренды и перспективы».** Контекст по рынку генеративный ИИ в России — https://yakovpartners.ru/publications/ai-2025/

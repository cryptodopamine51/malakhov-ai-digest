# Codex Publication Task: Claude в России 2026: как пользоваться, установить и оплатить

## Mode

- Publication mode: `create`
- Slug: `claude-v-rossii-kak-polzovatsya-ustanovit-i-oplatit`
- Public URL: `/guides/claude-v-rossii-kak-polzovatsya-ustanovit-i-oplatit`

If this is an update package, update the existing guide. Do not create a duplicate page for the same intent.

## Files to Create or Update

- Markdown: `content/guides/claude-v-rossii-kak-polzovatsya-ustanovit-i-oplatit.md`
- Metadata: `content/guides/meta/claude-v-rossii-kak-polzovatsya-ustanovit-i-oplatit.json`
- Images: `public/images/guides/claude-v-rossii-kak-polzovatsya-ustanovit-i-oplatit/*.webp`
...
- Keep canonical `https://news.malakhovai.ru/guides/claude-v-rossii-kak-polzovatsya-ustanovit-i-oplatit`.
...
```bash
npm run evergreen:check -- --slug=claude-v-rossii-kak-polzovatsya-ustanovit-i-oplatit
npm run docs:check
npm run build
```
...
- `/guides/claude-v-rossii-kak-polzovatsya-ustanovit-i-oplatit` returns 200 locally.

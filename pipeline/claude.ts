...
- Если источник указывает месяц или относительную дату без года, не добавляй год сам:
  пиши «в апреле», «к середине мая», «вчера» по смыслу источника, но не выдумывай «2025» или «2026».

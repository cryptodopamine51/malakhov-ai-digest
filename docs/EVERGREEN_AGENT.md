...
Cover **обязателен** (1200×675 WebP, ≥ 80 KB финал) и по умолчанию должен выглядеть как реалистичная редакционная фотография. Inline — обычно 2–4 шт. (1200×800 или 1200×1200): ChatGPT-картинки тоже делать в фотореализме; если нужна строгая матрица, схема или roadmap, лучше использовать локальный SVG/WebP как отдельное осознанное исключение.
